...
let pipes = user || `valeur par défaut`;
...
function creps(butter: boolean, rhum = false): void {
...
/* Paramètres rest */
function myArrayPush(...values: string[]): void {
